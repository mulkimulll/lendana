...
<div class="page-content bottom-content ">
    <div class="dz-banner-heading">
        <div class="overlay-black-light">
            <img src="{{ asset('assets/pwa/images/bg1.png') }}" class="bnr-img" alt="">
        </div>
    </div>
    <div class="container profile-area">
        <div class="profile">
            <div class="media media-100">
                <img src="{{ asset('assets/pwa/images/author/pic1.png') }}" alt="/">
            </div>
            <div class="mb-2">
                <h4 class="mb-0">User Test</h4>
            ...
            <li class="d-flex align-items-center px-4">
                <a href="#" class="contact-icon">
                    <svg class="text-primary" width="24" height="24" viewBox="0 0 28 28" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M27.0761 6.24662C26.9621 5.48439 26.5787 4.78822 25.9955 4.28434C25.4123 3.78045 24.6679 3.50219 23.8972 3.5H4.10295C3.33223 3.50219 2.58781 3.78045 2.00462 4.28434C1.42143 4.78822 1.03809 5.48439 0.924072 6.24662L14.0001 14.7079L27.0761 6.24662Z"
                            fill="#40189D" />
                        <path
        ...
        <div class="pdf-bx">
            <a href="javascript:void(0);">
                <h5 class="text-white">CV User test</h5>
                <span class="text-warning">Silahkan Upload CV</span>
            </a>
            <div class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle" id="dropdownMenu2" data-bs-toggle="dropdown"
                    aria-expanded="false">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                    <li><button class="dropdown-item" type="button">Upload Dokumen</button></li>
        ...
        <div class="skill-section">
            <h5>Riwayat pendidikan <span><a href=""><i class="fa fa-plus-circle"></i></a></span></h5>
            <div class="row g-3">
                <div class="text-center">
                    <img src="{{ asset('assets/img/form-null.png') }}" alt="" style="height: 150px; width:150px">
                    <p class="mt-1">Belum ada data <br> Silahkan lengkapi data anda</p>
                </div>
            </div>
        </div>
        <div class="skill-section">
            <h5>Riwayat pekerjaan <span><a href=""><i class="fa fa-plus-circle"></i></a></span></h5>
        ...
        <div class="skill-section">
            <h5>Pelatihan <span><a href=""><i class="fa fa-plus-circle"></i></a></span></h5>
        ...
        <div class="skill-section">
            <h5>Keahlian <span><a href=""><i class="fa fa-plus-circle"></i></a></span></h5>
