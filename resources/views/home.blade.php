            ...
            <div class="content-inner pt-0">
                <div class="container fb">
                    ...
                    <div class="dashboard-area m-t40">
                        ...
                        <div class="m-b10">
                            <div class="title-bar">
                                <h5 class="dz-title">Rekomendasi Lowongan</h5>
                                            ...
                                            <div class="card job-post">
                                                <div class="card-body">
                                                    <div class="media media-80">
                                                        <img src="assets/pwa/images/logo/logo.png" alt="/">
                                                    </div>
                                                    <div class="card-info">
                                                        <h6 class="title"><a href="javascript:void(0);">Software
                                                                Engineer</a></h6>
                                                        <span class="location">West Region, Singapore</span>
